...
class TTSInterface(metaclass=abc.ABCMeta):
    ...
    def play_audio_file_local(self, audio_file_path: str) -> None:
        ...
        """
        # Desktop mode streams audio to Chromium and never needs this path.
        # Import lazily so optional local playback dependencies do not emit
        # ffmpeg warnings during normal backend startup.
